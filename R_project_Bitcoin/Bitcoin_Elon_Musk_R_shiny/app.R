  ...
  tabPanel(h3("Elon Musk Tweets and Bitcoin Prices"),
         sidebarLayout(
           sidebarPanel(
             ...
             p("\ - Date: February 7, 2021: \"@itsALLrisky It’s the most fun crypto!\" SC = .51"),
             ...
             p("\ - Date: May 14, 2021: \"To be clear, I strongly believe in crypto, but it can’t drive a massive increase in fossil fuel use, especially coal\" SC = .56"),
             h5(strong("Negative Tweets:")),
             p("\ - Date: February 21, 2021: \"Heard a rumor some crypto coin was pegging the dollar 🤣🤣\" SC= -.07"),
             ...
             p("\ - Date: February 10, 2021: \"@freewalletorg Any crypto wallet that won’t give you your private keys should be avoided at all costs\" SC = .00"),
             br(),
             br(),
             br(),
